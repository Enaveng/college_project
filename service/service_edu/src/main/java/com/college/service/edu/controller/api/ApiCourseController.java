...
import com.college.service.edu.entity.vo.WebCourseQueryVo;
...
public class ApiCourseController {
    ...
    @ApiOperation("课程列表")
    @GetMapping("/list")
    public R pageList(@ApiParam("前台组装的查询条件")
                      WebCourseQueryVo webCourseQueryVo) {
        List<Course> courseList = courseService.webGetCourseList(webCourseQueryVo);
